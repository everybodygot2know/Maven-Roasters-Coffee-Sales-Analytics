...
Advanced Excel-based analysis and supply chain modeling using 149k+ transaction records from Maven Roasters (January–June 2023) across three NYC locations.

Original data source: https://www.kaggle.com/datasets/agungpambudi/trends-product-coffee-shop-sales-revenue-dataset/data
